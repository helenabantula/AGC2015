...
load AGC15_Challenge1_Training

% Provide the path to the input images, for example 
% 'C:\AGC_Challenge_2015\images\'
imgPath = [];
...
for j = 1 : length( AGC15_Challenge1_TRAINING )
    A = imread( sprintf('%s%s',...
        imgPath, AGC15_Challenge1_TRAINING(j).imageName ));    
...
FD_score = CHALL_AGC15_ComputeDetScores(...
    DetectionSTR, AGC15_Challenge1_TRAINING, 0);
